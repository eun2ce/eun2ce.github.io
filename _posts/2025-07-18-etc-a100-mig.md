---
title: "[A100/MIG] 동일 PID가 여러 GPU에 표시될 때 해결 가이드"
description: "A100 80GB 서버에서 하나의 PID가 여러 GPU에 중복 표기되는 현상을 원인 분석(MIG 비활성화, 자원 격리 부재)과 MIG 구성 절차로 해결한 사례 정리."
date: 2025-07-18 09:57:00 +0900
categories: [ "infrastructure", "gpu" ]
tags: [ "a100", "mig", "multi-instance-gpu", "nvidia-smi", "cuda", "troubleshooting" ]
pin: false
math: false
mermaid: false
---
